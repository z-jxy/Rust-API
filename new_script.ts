let roomListDiv = document.getElementById('room-list') as HTMLElement;
let messagesDiv = document.getElementById('messages') as HTMLElement;
//const messagesDiv_ = document.getElementById('messages') as HTMLElement;
let newMessageForm = document.getElementById('new-message') as HTMLElement;
let newRoomForm = document.getElementById('new-room') as HTMLElement;
let statusDiv = document.getElementById('status') as HTMLElement;

//let roomTemplate = document.getElementById('room') as HTMLElement;
//let messageTemplate = document.getElementById('message') as HTMLElement;
let messageField = newMessageForm.querySelector("#message") as HTMLElement;
let usernameField = newMessageForm.querySelector("#username") as HTMLElement;
let roomNameField = newRoomForm.querySelector("#name") as HTMLElement;

interface Fields {
  messageField_: HTMLElement;
  userNameField_: HTMLElement;
  roomNameField_: HTMLElement;
}


//let messageField_: typeof newMessageForm | null = "#message";


const messageTemplate: HTMLElement | null = document.getElementById('message');

if (messageTemplate instanceof HTMLMetaElement) {
  messageTemplate.content;
} else {
  throw new Error("no msg template /:")
}

const roomTemplate: HTMLElement | null = document.getElementById('room');

if (roomTemplate instanceof HTMLMetaElement) {
  roomTemplate.content;
} else {
  throw new Error("no room template /:")
}

//let z = roomTemplate.content.cloneNode()
...
function setConnectedStatus(status) {
  ...
  statusDiv.className = (status) ? "connected" : "reconnecting" || null ;
}
